...
__DEFINE__(1647657611243, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1647657611244,"./event-store":1647657611245}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647657611244, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1647657611245, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1647657611244,"./utils":1647657611246}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647657611246, function(require, module, exports) {
...
return __REQUIRE__(1647657611243);
})()
